...
/* download settings */
char* download_dir     = "~/down/";
char* download_command = "mlterm -e sh -c \"wget -q --load-cookies ~/.config/jumanji/cookies '%s' -O - > '%s'\"";
char* spawn_editor = "mlterm -e sh -c \"vi %s\"";

/* look */
char* font                   = "unicode normal 9";
char* default_bgcolor        = "#1C1C1C";
char* default_fgcolor        = "#D0D0D0";
...
Shortcut shortcuts[] = {
  ...
  {0,                  GDK_c,             sc_follow_link,       NORMAL,       { -1,                 NULL } },
  {0,                  GDK_C,             sc_follow_link,       NORMAL,       { -2,                 NULL } },
  ...
  {0,                  GDK_h,             sc_nav_tabs,          NORMAL,       { PREVIOUS,           NULL } },
  {0,                  GDK_j,             sc_scroll,            NORMAL,       { DOWN,               NULL } },
  {0,                  GDK_k,             sc_scroll,            NORMAL,       { UP,                 NULL } },
  {0,                  GDK_l,             sc_nav_tabs,          NORMAL,       { NEXT,               NULL } },
